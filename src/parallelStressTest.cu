/**
 * @file parallelStressTest.cu
 * @brief Randomized stress test for the parallel (CUDA) SOSP update algorithm.
 *
 ...
 *
 * Identical to stressTest.cu except it calls parallelSOSPUpdate() instead
